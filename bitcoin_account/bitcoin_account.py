...
def keypair_gen_privatekey(is_wif_private_key: bool, encoded_key: str):
...
def convert_to_wif_private_key(private_key_bytes: bytes):
...
def convert_to_bitcoin_address(public_key_bytes: bytes):
