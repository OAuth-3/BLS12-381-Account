...
from pure25519.basic import (Q, L, B, ElementOfUnknownGroup, arbitrary_element, password_to_scalar, bytes_to_element, bytes_to_unknown_group_element, _add_elements_nonunfied, add_elements, encodepoint, xform_extended_to_affine, xform_affine_to_extended)
from pure25519.basic import Base, Element, Zero
from pure25519.slow_basic import (slow_add_affine, scalarmult_affine, scalarmult_affine_to_extended)
...
class Basic(unittest.TestCase):
    ...
    def test_orders(self):
        ...
        self.assertBytesEqual(encodepoint(xform_extended_to_affine(p3)), encodepoint(xform_extended_to_affine(p0)))
        self.assertBytesEqual(encodepoint(xform_extended_to_affine(p4)), encodepoint(xform_extended_to_affine(p2)))
        self.assertBytesEqual(encodepoint(xform_extended_to_affine(p5)), encodepoint(xform_extended_to_affine(p0)))
